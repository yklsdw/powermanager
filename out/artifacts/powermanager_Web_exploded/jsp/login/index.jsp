		...
		<div class='login'>
			...
			<div class='login_fields'>
				<div class='login_fields__user'>
					...
					<input name="username" id="username" placeholder='请输入手机号码' maxlength="16" type='text' autocomplete="off"  value="18361465555" />
				...
				<div class='login_fields__password'>
					...
					<input name="password" id="password" placeholder='请输入密码' maxlength="16" type='password' autocomplete="off" value="000000">
